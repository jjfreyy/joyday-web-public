<?= view("templates/header", ["title" => "Tampil Barang Masuk", "data" => "dialog"]) ?>

<section id="scol1" class="main">
	<input type="text" class="hidden" id="id_level" value="<?= $id_level ?>">
			...
			<div class="search_box2">
				...
				<div class="select_box">
					...
					<select name="tipe" id="tipe">
							...
							<option value="0">Dari Distributor</option>
							<option value="1">Dari Pelanggan</option>
							<option value="2">Ke Agen</option>
					</select>
				</div>
...
<?= view("templates/footer", ["data" => ["dialog", "tampil/barang_masuk"]]) ?>
